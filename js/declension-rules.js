...
const declensionRules = {
    ...
    "a-pungling": { // อ การันต์, ปุงลิงค์ (เช่น พุทฺธ, โจร, อาจริย, บุริส)
        ...
        "สัตตมี": {
            ...
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อ+สฺมิํ = อสฺมิํ / อ+สฺมิํ = อมฺหิ / อ+สฺมิํ = เอ", "explanation_general": "คง สฺมิํ ไว้ / แปลง สฺมิํ เป็น มฺหิ / ลบ อ, แปลง สฺมิํ เป็น เอ", "final_suffix": ["อสฺมิํ", "อมฺหิ", "เอ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อ+สุ = เอสุ", "explanation_general": "แปลง อ เป็น เอ, คง สุ ไว้", "final_suffix": "เอสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
    ...
    "i-pungling": { // อิ การันต์, ปุงลิงค์ (เช่น มุนิ, อคฺคิ)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อิ+สฺมิํ = อิสฺมิํ / อิ+สฺมิํ = อิมฺหิ", "explanation_general": "คง สฺมิํ ไว้ / แปลง สฺมิํ เป็น มฺหิ", "final_suffix": ["อิสฺมิํ", "อิมฺหิ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }, // มักใช้ อิสฺมิํ, อิมฺหิ
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อิ+สุ = อีสุ", "explanation_general": "แปลง อิ เป็น อ, คง สุ ไว้", "final_suffix": "อีสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " } // มุนีสุ
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "e-pungling": { // อี การันต์, ปุงลิงค์ (เช่น เสฏฺฐี, กรี)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อี+สฺมิํ = อิสฺมิํ / อี+สฺมิํ = อิมฺหิ", "explanation_general": "รัสสะ อี เป็น อิ, คง สฺมิํ ไว้ / รัสสะ อี เป็น อิ, แปลง สฺมิํ เป็น มฺหิ", "final_suffix": ["อิสฺมิํ", "อิมฺหิ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อี+สุ = อีสุ", "explanation_general": "คง สุ ไว้", "final_suffix": "อีสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "u-pungling": { // อุ การันต์, ปุงลิงค์ (เช่น ครุ, ภิกขุ)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อุ+สฺมิํ = อุสฺมิํ / อุ+สฺมิํ = อุมฺหิ", "explanation_general": "คง สฺมิํ ไว้ / แปลง สฺมิํ เป็น มฺหิ", "final_suffix": ["อุสฺมิํ", "อุมฺหิ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อุ+สุ = อูสุ", "explanation_general": "ทีฆะ อุ เป็น อู, คง สุ ไว้", "final_suffix": "อูสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "oo-pungling": { // อู การันต์, ปุงลิงค์ (เช่น วิญฺญู, วิทู)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อู+สฺมิํ = อุสฺมิํ / อู+สฺมิํ = อุมฺหิ", "explanation_general": "รัสสะ อู เป็น อุ, คง สฺมิํ ไว้ / รัสสะ อู เป็น อุ, แปลง สฺมิํ เป็น มฺหิ", "final_suffix": ["อุสฺมิํ", "อุมฺหิ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อู+สุ = อูสุ", "explanation_general": "คง สุ ไว้", "final_suffix": "อูสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "aa-itthiling": { // อา การันต์, อิตถีลิงค์ (เช่น กญฺญา, ตารา)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อา+สฺมิํ = อาย / อา+สฺมิํ = อายํ", "explanation_general": "ลบ อา, แปลง สฺมิํ เป็น อาย / แปลง สฺมิํ เป็น ยํ", "final_suffix": ["อาย", "อายํ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อา+สุ = อาสุ", "explanation_general": "คง สุ ไว้", "final_suffix": "อาสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "i-itthiling": { // อิ การันต์, อิตถีลิงค์ (เช่น รตฺติ, ภูมิ)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อิ+สฺมิํ = อิยา / อิ+สฺมิํ = อิยํ / อิ+สฺมิํ = ยํ", "explanation_general": "แปลง สฺมิํ เป็น ยา / แปลง สฺมิํ เป็น ยํ / แปลง อิ เป็น ยฺ (ลบพยัญชนะที่มีรูปเหมือนกัน), แปลง สฺมิํ เป็น อํ", "final_suffix": ["อิยา", "อิยํ", "ฺยํ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อิ+สุ = อีสุ", "explanation_general": "ทีฆะ อิ เป็น อี, คง สุ ไว้", "final_suffix": "อีสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "e-itthiling": { // อี การันต์, อิตถีลิงค์ (เช่น นารี, กุมารี)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อี+สฺมิํ = อิยา / อี+สฺมิํ = อิยํ", "explanation_general": "รัสสะ อี เป็น อิ, แปลง สฺมิํ เป็น ยา / รัสสะ อี เป็น อิ, แปลง สฺมิํ เป็น ยํ", "final_suffix": ["อิยา", "อิยํ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อี+สุ = อีสุ", "explanation_general": "คง สุ ไว้", "final_suffix": "อีสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "u-itthiling": { // อุ การันต์, อิตถีลิงค์ (เช่น รชฺชุ)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อุ+สฺมิํ = อุยา / อุ+สฺมิํ = อุยํ", "explanation_general": "แปลง สฺมิํ เป็น ยา / แปลง สฺมิํ เป็น ยํ", "final_suffix": ["อุยา", "อุยํ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อุ+สุ = อูสุ", "explanation_general": "ทีฆะ อุ เป็น อู, คง สุ ไว้", "final_suffix": "อูสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "oo-itthiling": { // อู การันต์, อิตถีลิงค์ (เช่น วธู, ภิกขุนี, (สำหรับ วธู เป็นทั้ง อุ และ อู การันต์))
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อู+สฺมิํ = อุยา / อู+สฺมิํ = อุยํ", "explanation_general": "รัสสะ อู เป็น อุ, แปลง สฺมิํ เป็น ยา / รัสสะ อู เป็น อุ, แปลง สฺมิํ เป็น ยํ", "final_suffix": ["อุยา", "อุยํ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อู+สุ = อูสุ", "explanation_general": "คง สุ ไว้", "final_suffix": "อูสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "a-napun": { // อ การันต์, นปุงสกลิงค์ (เช่น กุล, วน, จิตฺต)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อ+สฺมิํ = อสฺมิํ / อ+สฺมิํ = อมฺหิ / อ+สฺมิํ = เอ", "explanation_general": "คง สฺมิํ ไว้ / แปลง สฺมิํ เป็น มฺหิ / ลบ อ, แปลง สฺมิํ เป็น เอ", "final_suffix": ["อสฺมิํ", "อมฺหิ", "เอ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อ+สุ = เอสุ", "explanation_general": "เอา อ เป็น เอ, คง สุ ไว้", "final_suffix": "เอสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "i-napun": { // อิ การันต์, นปุงสกลิงค์ (เช่น อตฺถิ)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อิ+สฺมิํ = อิสฺมิํ / อิ+สฺมิํ = อิมฺหิ", "explanation_general": "คง สฺมิํ / แปลง สฺมิํ เป็น มฺหิ", "final_suffix": ["อิสฺมิํ", "อิมฺหิ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อิ+สุ = อีสุ", "explanation_general": "ทีฆะ อิ เป็น อี, คง สุ ไว้", "final_suffix": "อีสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
    ...
    "u-napun": { // อุ การันต์, นปุงสกลิงค์ (เช่น จกฺขุ, อายุ)
        ...
        "สัตตมี": {
            "karaka": "แสดงความเป็นอาธาร คือ ที่ตั้ง, สถานที่/โอกาส", "short_name": "ส.",
            "เอกวจนะ": { "suffix_orig": "สฺมิํ", "formula_general": "อุ+สฺมิํ = อุสฺมิํ / อุ+สฺมิํ = อุมฺหิ", "explanation_general": "คง สฺมิํ / แปลง สฺมิํ เป็น มฺหิ", "final_suffix": ["อุสฺมิํ", "อุมฺหิ"], "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " },
            "พหุวจนะ": { "suffix_orig": "สุ", "formula_general": "อุ+สุ = อูสุ", "explanation_general": "ทีฆะ อุ เป็น อู, คง สุ ไว้", "final_suffix": "อูสุ", "meaning": "ใน, ใกล้, ที่, ครั้นเมื่อ, ในเพราะ, เหนือ, บน, ณ " }
        },
        "อาลปนะ": {
            "karaka": "แสดงความเป็นอาลปน คือ คำสำหรับร้องเรียก", "short_name": "อา.",
